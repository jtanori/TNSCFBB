...
var aspect = (function () {
     ...
     * @private
     */
    var __executeAspects = function (obj, fn, aspects, when, args) {
        var i, len, aspectFn;
    ...
    out.add = function (obj, fn, aspectFn, when, once) {
        ...
        obj[fn] = function () {
            ...
            __executeAspects(obj, fn, aspects, "before", Array.prototype.slice.call(arguments));

            result = obj.$$aspects[fn].org.apply(obj, Array.prototype.slice.call(arguments));

            __executeAspects(obj, fn, aspects, "after", Array.prototype.slice.call(arguments));
